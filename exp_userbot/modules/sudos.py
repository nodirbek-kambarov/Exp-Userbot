...
@expub_on_cmd(command="addsudo", modlue=mod_file)
async def set_sudo(_, message: Message):
  sudo_msg = await e_or_r(expub_message=message, msg_text="`Processing...`")
...
@expub_on_cmd(command="rsudo", modlue=mod_file)
async def set_sudo(_, message: Message):
  sudo_msg = await e_or_r(expub_message=message, msg_text="`Processing...`")
  sudo_id = str(get_arg(message))
  r_sudo_msg = message.reply_to_message
...
@expub_on_cmd(command="setvar", modlue=mod_file)
async def setmongovar(_, message: Message):
  setvr_msg = await e_or_r(expub_message=message, msg_text="`Processing...`")
